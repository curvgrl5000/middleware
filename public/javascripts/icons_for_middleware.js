...
var startpoint = Raphael('starting_point', 120, 120);
...
var endpoint = Raphael('ending_point', 120, 120);
...
// Icon10: OpenTarget
var paper = new Raphael(document.getElementById('open-target'), 120, 120); //the more verbose option
...
var paper = Raphael('open-arrowright', 120, 120); //this version is tidier and here we're passing an absolute path  
...
// This was done by hand and the transform function was used to scale   
var paper = Raphael('open-arrow-right-wide', 120, 120); 
var arrow = paper.set();
...
var paper = Raphael('open-circleband', 120, 120);
...
var paper = Raphael('open-arrowleft', 120, 120); //this version is tidier and here we're passing an absolute path  
...
// This was done by hand and the transform function was used to scale   
var paper = Raphael('open-arrow-left-wide', 120, 120); 
var arrow = paper.set();
arrow.push(paper.circle(48, 48, 40).attr({ stroke: "#000", "stroke-width": 10  }));
...
zoom.setViewBox(-2, -2, 77, 77);  
// END Zoom

// Icon17: Zoomed, expressed as a 'path;
// This was done by hand and the transform function was used to scale  
var paper = Raphael('plus', 120, 120);  
var circled = paper.set();
circled.push(paper.circle(48, 48, 44).attr({ fill: "#000", transform: "T30" }));  
var x = paper.set();
...
// This was done by hand and the transform function was used to scale  
var paper = Raphael('minus', 120, 120);  
var circled = paper.set();
circled.push(paper.circle(48, 48, 44).attr({ fill: "#000", transform: "T30" }));  
var y = paper.set(); 
y.push(paper.path("M26,50 L70, 50z"))
